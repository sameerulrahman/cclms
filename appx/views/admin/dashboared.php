                        ...
                        <div class="direct-chat-messages">
                          ...
                          <div class="direct-chat-msg">
                            ...
                            <img
                              ...
                              src="<?php echo base_url(); ?>dist/assets/img/user1-128x128.jpg"
                          ...
                          <div class="direct-chat-msg end">
                            ...
                            <img
                              class="direct-chat-img"
                              src="<?php echo base_url(); ?>dist/assets/img/user3-128x128.jpg"
                              alt="message user image"
                            />
                            <!-- /.direct-chat-img -->
                          ...
                          <ul class="contacts-list">
                            ...
                            <li>
                              <a href="#">
                                <img
                                  class="contacts-list-img"
                                  src="<?php echo base_url(); ?>dist/assets/img/user7-128x128.jpg"
                                  alt="User Avatar"
                                />
                                <div class="contacts-list-info">
                                  <span class="contacts-list-name">
                            ...
                            <li>
                              <a href="#">
                                <img
                                  class="contacts-list-img"
                                  src="<?php echo base_url(); ?>dist/assets/img/user5-128x128.jpg"
                                  alt="User Avatar"
                                />
                                <div class="contacts-list-info">
                                  <span class="contacts-list-name">
                            ...
                            <li>
                              <a href="#">
                                <img
                                  class="contacts-list-img"
                                  src="<?php echo base_url(); ?>dist/assets/img/user6-128x128.jpg"
                                  alt="User Avatar"
                                />
                                <div class="contacts-list-info">
                                  <span class="contacts-list-name">
                            ...
                            <li>
                              <a href="#">
                                <img
                                  class="contacts-list-img"
                                  src="<?php echo base_url(); ?>dist/assets/img/user8-128x128.jpg"
                                  alt="User Avatar"
                                />
                                <div class="contacts-list-info">
                                  <span class="contacts-list-name">
                      ...
                      <div class="card-body p-0">
                        <div class="row text-center m-1">
                          ...
                          <div class="col-3 p-2">
                            <img
                              class="img-fluid rounded-circle"
                              src="<?php echo base_url(); ?>dist/assets/img/user4-128x128.jpg"
                              alt="User Image"
                            />
                            <a
                              class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0"
                  ...
                  <div class="card-body p-0">
                    <div class="px-2">
                      <div class="d-flex border-top py-2 px-1">
                        <div class="col-2">
                          <img
                            src="<?php echo base_url(); ?>dist/assets/img/default-150x150.png"
                            alt="Product Image"
                            class="img-size-50"
                          />
                        </div>
